...
from .imageProcessor import Input_processing
from .imageProcessor import img_name as imread
from .imageProcessor import img_size as imresize
from .imageProcessor import categorical_data
import scipy.ndimage as ndi
import cv2

class ImageLoder(object):
    
    def __init__(self, Databas, batch_size, image_size,
    ...
    def _gray_scale(self, image_array):
        return image_array.dot([224,224,1])
    ...
    def preprocess_images(self, image_array):
        return Input_processing(image_array)
            ...
            while True:
                ...
                for key in keys:
                    ...
                    if len(targets) == self.batch_size:
                        ...
                        targets = categorical_data(targets)
